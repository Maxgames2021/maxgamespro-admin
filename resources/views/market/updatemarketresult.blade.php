        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" action="/market/getmarketresultdetail" method="POST">
                        {{ csrf_field() }}
                ...
                <div class="modal-footer">
                    <div class="form-actions">
                        <button type="button" onclick="window.location='{{url('home')}}'" class="btn btn-warning mr-1">
                            Close
                        </button>
    ...
    <div class="content-body">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-1">
                <h2 class="content-header-title">Declare Result</h2>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                <div class="breadcrumb-wrapper col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Declare Result
                        </li>
                        </li>
                    </ol>
                </div>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <form class="form" method="POST" onSubmit="return Confirmation(event);">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly required id="marketName" name="marketName"
                                                   class="form-control" placeholder="Market Name">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required name="openPatti" id="openPatti"
                                                           class="form-control" placeholder="open patti" maxlength="3"
                                                           minlength="3"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>Open</label>
                                                    <input type="text" required name="open" id="open"
                                                           class="form-control" placeholder="open" maxlength="1"
                                                           minlength="1"
                                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>Close</label>
                                                    <input type="text" required name="close" id="close"
                                                           class="form-control" placeholder="close" maxlength="1"
                                                           minlength="1"
                                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required name="closePatti" id="closePatti"
                                                           class="form-control" placeholder="close patti" maxlength="3"
                                                           minlength="3"
                                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                                </div>
                                            </div>
                            ...
                            <div class="form-actions">
                                <button onclick="window.location='{{url('market/updatemarketresultform')}}'"
                                        type="button" class="btn btn-warning mr-1">
                                    <i class="icon-cross2"></i> Cancel
                                </button>
                                <button type="submit" name="save" class="btn btn-primary" formaction="/market/updatemarketresultrequest">
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            document.getElementsByName("openPatti")[0].value = '{{$marketResult['openPattiResult']}}';
            document.getElementsByName("open")[0].value = '{{$marketResult['openResult']}}';
            document.getElementsByName("closePatti")[0].value = '{{$marketResult['closePattiResult']}}';
    ...
    <script type="text/javascript">
        function Confirmation(e) {
            ...
            var openPatti = document.getElementById('openPatti').value;
            var open = document.getElementById('open').value;
            var close = document.getElementById('close').value;
            var closePatti = document.getElementById('closePatti').value;
            var result = openPatti + "-" + open + close + "-" + closePatti;
