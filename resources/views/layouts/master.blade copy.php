    ...
    <div class="navbar-wrapper">
      <div class="navbar-header">
        <ul class="nav navbar-nav">
          ...
          <li class="nav-item"><a href="{{url('home')}}" class="navbar-brand nav-link"><img alt="MG"
                ...
                data-collapse="/app-assets/images/logo/mg-loge-42x46.png" class="brand-logo"></a></li>
      ...
      <div class="navbar-container content container-fluid">
        <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
          ...
          <i class="icon-tv4"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Manage Offers</span></a>
          <div class="dropdown-menu" aria-labelledby="dropdown-flag">
          <a class="dropdown-item" href="{{url('offer/createofferform')}}">Create Offer</a>
          <a class="dropdown-item" href="{{url('offer/viewoffer')}}">Close Offer</a>
          </div>
          </li>
          <li class="dropdown dropdown-language nav-item">
          <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="icon-expeditedssl"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Management</span></a>
          <div class="dropdown-menu" aria-labelledby="dropdown-flag">
          <a class="dropdown-item" href="{{url('user/viewadminuser')}}">View Admins</a>
          <a class="dropdown-item" href="{{url('user/createadminprofile')}}">Create Admin</a>
          <a class="dropdown-item" href="{{url('user/restoreuserpassword')}}">Restore Password</a>
          <a class="dropdown-item" href="{{url('depositwithdrawalstatus')}}">Reset D/W Status</a>
          <a class="dropdown-item" href="{{url('stats')}}">Statistics</a>
          <a class="dropdown-item" href="{{url('adminactions')}}">Admin Actions</a>
          <a class="dropdown-item" href="{{url('paymentmodes')}}">Payment Modes</a>
          </div>
          </li>
          @endif
          <li class="nav-item">
          <a class="nav-link" href="{{url('user/updateadminprofile')}}" aria-haspopup="true" aria-expanded="false">
          <i class="icon-settings2"></i><span data-i18n="nav.page_layouts.main">Update Profile</span></a></li>
